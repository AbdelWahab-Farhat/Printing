...
abstract final class Routes {
  ...
  /// إنشاء رمز QR.
  ///
  /// تحت `/tools` رغم أنه **لا شاشة على `/tools` نفسها**: «الأدوات» قائمةٌ تنفتح تحت زرٍّ في
  /// شريط التطبيق بجانب الجرس — [ToolsMenuButton] — لا صفحةٌ تُفتح لتُفتح منها صفحة ثانية.
  /// المسار يبقى مصنَّفاً لأن الأداة الثانية تقف بجانبه، ولأن المسار الذي يقول أيَّ قسمٍ هذا
  /// يقرأه من يقرأ سجلّاً بعد شهر.
