...
_OrderPaymentReversal _$OrderPaymentReversalFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$OrderPaymentReversalToJson(_OrderPaymentReversal instance) =>
    <String, dynamic>{
      'id': instance.id,
...
_PaymentRecorder _$PaymentRecorderFromJson(Map<String, dynamic> json) => _PaymentRecorder(
  id: (json['id'] as num).toInt(),
  name: json['name'] as String,
  employeeCode: json['employee_code'] as String?,
);

Map<String, dynamic> _$PaymentRecorderToJson(_PaymentRecorder instance) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
  'employee_code': instance.employeeCode,
};

_PaymentSummary _$PaymentSummaryFromJson(Map<String, dynamic> json) => _PaymentSummary(
...
Map<String, dynamic> _$PaymentSummaryToJson(_PaymentSummary instance) => <String, dynamic>{
...
Map<String, dynamic> _$OrderLedgerToJson(_OrderLedger instance) => <String, dynamic>{
