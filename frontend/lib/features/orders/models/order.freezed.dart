...
@JsonKey(name: 'reinstate_to_label') String? get reinstateToLabel;/// The journey, in the domain's own order — see [OrderProgress].
...
/// counted.
@JsonKey(name: 'warehouse_quantity') String? get warehouseQuantity;/// **Null on a line nobody has priced yet**, which happens in exactly one place: a request
...
@JsonKey(name: 'unit_price') String? get unitPrice;@JsonKey(name: 'line_total') String? get lineTotal;/// The accrual side of [lineTotal]: what this line cost to make, split three ways and
