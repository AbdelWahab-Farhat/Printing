...
_OrderItem _$OrderItemFromJson(Map<String, dynamic> json) => _OrderItem(
  ...
  shortageWarehouseQuantity: json['shortage_warehouse_quantity'] as String?,
  ...
  isStockedInAnotherUnit: json['is_stocked_in_another_unit'] as bool?,
...
Map<String, dynamic> _$OrderItemToJson(_OrderItem instance) =>
    <String, dynamic>{
      ...
      'shortage_warehouse_quantity': instance.shortageWarehouseQuantity,
      ...
      'material_cost_actual': instance.materialCostActual,
      'stock_purchased_at': instance.stockPurchasedAt,
      ...
      'is_stocked_in_another_unit': instance.isStockedInAnotherUnit,
