...
abstract interface class CommentRepository {
  ...
  /// يعلّم كلّ ما في هذه المحادثة مقروءاً لهذا المستخدم، ويجيب بعدد ما بقي غير مقروءٍ في الحساب
  /// كلّه — رقمُ الجرس الجديد.
  ///
  /// **لتذكرة التصميم وحدها اليوم.** هي الوحيدة التي يُرسل الخادمُ عن ردودها إشعاراً، فهي
  /// الوحيدة التي لها ما يُطفأ؛ وملاحظةُ العميل لا شارة لها أصلاً. والنداء لغيرها لا يخرج إلى
  /// الشبكة ويجيب بالصفر — انظر [CommentRepositoryImpl]، وهي الذراع التي تُملأ يوم تُطلب شارةٌ
  /// هناك.
  Future<Either<Failure, int>> markThreadRead(CommentSubject subject);
}
