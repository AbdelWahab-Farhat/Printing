...
/// customers.
@JsonKey(name: 'customer_name') String get customerName;@JsonKey(name: 'order_id') int? get orderId; DesignTicketOrder? get order; DesignTicketActor? get requester;/// **Two people, and they answer different questions.** [designer] is who the ticket is
...
/// Create a copy of DesignTicket
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? code = null,Object? title = null,Object? description = null,Object? instructions = freezed,Object? status = null,Object? statusLabel = null,Object? isOpen = null,Object? isClosed = null,Object? availableTransitions = null,Object? customerId = null,Object? customerName = null,Object? orderId = freezed,Object? order = freezed,Object? requester = freezed,Object? designer = freezed,Object? acceptedBy = freezed,Object? acceptedAt = freezed,Object? isInSharedPool = null,Object? approvedBy = freezed,Object? completedAt = freezed,Object? approvedCustomerDesignId = freezed,Object? approvedDesign = freezed,Object? cancellationReason = freezed,Object? versionsCount = freezed,Object? attachments = null,Object? versions = null,Object? canAccept = null,Object? canSubmit = null,Object? canReview = null,Object? canAssign = null,Object? canManage = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,code: null == code ? _self.code : code // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _DesignTicket() when $default != null:
return $default(_that.id,_that.code,_that.title,_that.description,_that.instructions,_that.status,_that.statusLabel,_that.isOpen,_that.isClosed,_that.availableTransitions,_that.customerId,_that.customerName,_that.orderId,_that.order,_that.requester,_that.designer,_that.acceptedBy,_that.acceptedAt,_that.isInSharedPool,_that.approvedBy,_that.completedAt,_that.approvedCustomerDesignId,_that.approvedDesign,_that.cancellationReason,_that.versionsCount,_that.attachments,_that.versions,_that.canAccept,_that.canSubmit,_that.canReview,_that.canAssign,_that.canManage,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DesignTicket&&(identical(other.id, id) || other.id == id)&&(identical(other.code, code) || other.code == code)&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description)&&(identical(other.instructions, instructions) || other.instructions == instructions)&&(identical(other.status, status) || other.status == status)&&(identical(other.statusLabel, statusLabel) || other.statusLabel == statusLabel)&&(identical(other.isOpen, isOpen) || other.isOpen == isOpen)&&(identical(other.isClosed, isClosed) || other.isClosed == isClosed)&&const DeepCollectionEquality().equals(other._availableTransitions, _availableTransitions)&&(identical(other.customerId, customerId) || other.customerId == customerId)&&(identical(other.customerName, customerName) || other.customerName == customerName)&&(identical(other.orderId, orderId) || other.orderId == orderId)&&(identical(other.order, order) || other.order == order)&&(identical(other.requester, requester) || other.requester == requester)&&(identical(other.designer, designer) || other.designer == designer)&&(identical(other.acceptedBy, acceptedBy) || other.acceptedBy == acceptedBy)&&(identical(other.acceptedAt, acceptedAt) || other.acceptedAt == acceptedAt)&&(identical(other.isInSharedPool, isInSharedPool) || other.isInSharedPool == isInSharedPool)&&(identical(other.approvedBy, approvedBy) || other.approvedBy == approvedBy)&&(identical(other.completedAt, completedAt) || other.completedAt == completedAt)&&(identical(other.approvedCustomerDesignId, approvedCustomerDesignId) || other.approvedCustomerDesignId == approvedCustomerDesignId)&&(identical(other.approvedDesign, approvedDesign) || other.approvedDesign == approvedDesign)&&(identical(other.cancellationReason, cancellationReason) || other.cancellationReason == cancellationReason)&&(identical(other.versionsCount, versionsCount) || other.versionsCount == versionsCount)&&const DeepCollectionEquality().equals(other._attachments, _attachments)&&const DeepCollectionEquality().equals(other._versions, _versions)&&(identical(other.canAccept, canAccept) || other.canAccept == canAccept)&&(identical(other.canSubmit, canSubmit) || other.canSubmit == canSubmit)&&(identical(other.canReview, canReview) || other.canReview == canReview)&&(identical(other.canAssign, canAssign) || other.canAssign == canAssign)&&(identical(other.canManage, canManage) || other.canManage == canManage)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,code,title,description,instructions,status,statusLabel,isOpen,isClosed,const DeepCollectionEquality().hash(_availableTransitions),customerId,customerName,orderId,order,requester,designer,acceptedBy,acceptedAt,isInSharedPool,approvedBy,completedAt,approvedCustomerDesignId,approvedDesign,cancellationReason,versionsCount,const DeepCollectionEquality().hash(_attachments),const DeepCollectionEquality().hash(_versions),canAccept,canSubmit,canReview,canAssign,canManage,createdAt,updatedAt]);
...
/// Create a copy of DesignTicket
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? code = null,Object? title = null,Object? description = null,Object? instructions = freezed,Object? status = null,Object? statusLabel = null,Object? isOpen = null,Object? isClosed = null,Object? availableTransitions = null,Object? customerId = null,Object? customerName = null,Object? orderId = freezed,Object? order = freezed,Object? requester = freezed,Object? designer = freezed,Object? acceptedBy = freezed,Object? acceptedAt = freezed,Object? isInSharedPool = null,Object? approvedBy = freezed,Object? completedAt = freezed,Object? approvedCustomerDesignId = freezed,Object? approvedDesign = freezed,Object? cancellationReason = freezed,Object? versionsCount = freezed,Object? attachments = null,Object? versions = null,Object? canAccept = null,Object? canSubmit = null,Object? canReview = null,Object? canAssign = null,Object? canManage = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
