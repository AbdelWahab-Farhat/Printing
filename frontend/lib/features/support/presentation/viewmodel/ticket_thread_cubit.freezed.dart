...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( TicketThreadLoading value)?  loading,TResult Function( TicketThreadFailure value)?  failure,TResult Function( TicketThreadLoaded value)?  loaded,required TResult orElse(),}){
final _that = this;
switch (_that) {
case TicketThreadLoading() when loading != null:
return loading(_that);case TicketThreadFailure() when failure != null:
return failure(_that);case TicketThreadLoaded() when loaded != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( TicketThreadLoading value)  loading,required TResult Function( TicketThreadFailure value)  failure,required TResult Function( TicketThreadLoaded value)  loaded,}){
final _that = this;
switch (_that) {
case TicketThreadLoading():
return loading(_that);case TicketThreadFailure():
return failure(_that);case TicketThreadLoaded():
return loaded(_that);}
}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( TicketThreadLoading value)?  loading,TResult? Function( TicketThreadFailure value)?  failure,TResult? Function( TicketThreadLoaded value)?  loaded,}){
final _that = this;
switch (_that) {
case TicketThreadLoading() when loading != null:
return loading(_that);case TicketThreadFailure() when failure != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( Failure failure)?  failure,TResult Function( SupportTicket ticket,  bool isWorking,  Failure? lastFailure)?  loaded,required TResult orElse(),}) {final _that = this;
switch (_that) {
case TicketThreadLoading() when loading != null:
return loading();case TicketThreadFailure() when failure != null:
return failure(_that.failure);case TicketThreadLoaded() when loaded != null:
return loaded(_that.ticket,_that.isWorking,_that.lastFailure);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( Failure failure)  failure,required TResult Function( SupportTicket ticket,  bool isWorking,  Failure? lastFailure)  loaded,}) {final _that = this;
switch (_that) {
case TicketThreadLoading():
return loading();case TicketThreadFailure():
return failure(_that.failure);case TicketThreadLoaded():
return loaded(_that.ticket,_that.isWorking,_that.lastFailure);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( Failure failure)?  failure,TResult? Function( SupportTicket ticket,  bool isWorking,  Failure? lastFailure)?  loaded,}) {final _that = this;
switch (_that) {
case TicketThreadLoading() when loading != null:
return loading();case TicketThreadFailure() when failure != null:
return failure(_that.failure);case TicketThreadLoaded() when loaded != null:
...
class TicketThreadLoaded implements TicketThreadState {
  const TicketThreadLoaded({required this.ticket, this.isWorking = false, this.lastFailure});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TicketThreadLoaded&&(identical(other.ticket, ticket) || other.ticket == ticket)&&(identical(other.isWorking, isWorking) || other.isWorking == isWorking)&&(identical(other.lastFailure, lastFailure) || other.lastFailure == lastFailure));
}


@override
int get hashCode => Object.hash(runtimeType,ticket,isWorking,lastFailure);

@override
String toString() {
  return 'TicketThreadState.loaded(ticket: $ticket, isWorking: $isWorking, lastFailure: $lastFailure)';
}
...
@useResult
$Res call({
 SupportTicket ticket, bool isWorking, Failure? lastFailure
});
...
/// Create a copy of TicketThreadState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? ticket = null,Object? isWorking = null,Object? lastFailure = freezed,}) {
  return _then(TicketThreadLoaded(
ticket: null == ticket ? _self.ticket : ticket // ignore: cast_nullable_to_non_nullable
as SupportTicket,isWorking: null == isWorking ? _self.isWorking : isWorking // ignore: cast_nullable_to_non_nullable
