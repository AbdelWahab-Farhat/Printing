...
mixin _$Shortage {
 ...
 int get id; String get code;@JsonKey(unknownEnumValue: ShortageSource.unknown) ShortageSource get source;@JsonKey(name: 'source_label') String get sourceLabel;/// «كيس شحن — 25*35», or whatever somebody typed on a manual one.
...
@JsonKey(name: 'is_stockable') bool get isStockable;@JsonKey(name: 'order_id') int? get orderId;@JsonKey(name: 'order_item_id') int? get orderItemId; ShortageOrderRef? get order;@JsonKey(name: 'customer_id') int? get customerId; ShortageCustomerRef? get customer;@JsonKey(name: 'product_id') int? get productId;@JsonKey(name: 'product_variant_id') int? get productVariantId; ShortageProductRef? get product; ShortageVariantRef? get variant;@JsonKey(name: 'assigned_to_user_id') int? get assignedToUserId; ShortagePerson? get assignee;@JsonKey(name: 'created_by_user_id') int? get createdByUserId; ShortagePerson? get creator; String? get description;/// The ledger — **detail payload only**, so an empty list on a card means «not asked for»
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,code,source,sourceLabel,name,unit,unitLabel,requiredQuantity,suppliedQuantity,remainingQuantity,totalPaid,status,statusLabel,isFinal,const DeepCollectionEquality().hash(availableTransitions),isEditable,isStockable,orderId,orderItemId,order,customerId,customer,productId,productVariantId,product,variant,assignedToUserId,assignee,createdByUserId,creator,description,const DeepCollectionEquality().hash(supplies),createdAt,updatedAt]);

@override
String toString() {
  return 'Shortage(id: $id, code: $code, source: $source, sourceLabel: $sourceLabel, name: $name, unit: $unit, unitLabel: $unitLabel, requiredQuantity: $requiredQuantity, suppliedQuantity: $suppliedQuantity, remainingQuantity: $remainingQuantity, totalPaid: $totalPaid, status: $status, statusLabel: $statusLabel, isFinal: $isFinal, availableTransitions: $availableTransitions, isEditable: $isEditable, isStockable: $isStockable, orderId: $orderId, orderItemId: $orderItemId, order: $order, customerId: $customerId, customer: $customer, productId: $productId, productVariantId: $productVariantId, product: $product, variant: $variant, assignedToUserId: $assignedToUserId, assignee: $assignee, createdByUserId: $createdByUserId, creator: $creator, description: $description, supplies: $supplies, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
/// Create a copy of Shortage
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? code = null,Object? source = null,Object? sourceLabel = null,Object? name = null,Object? unit = freezed,Object? unitLabel = freezed,Object? requiredQuantity = null,Object? suppliedQuantity = null,Object? remainingQuantity = null,Object? totalPaid = null,Object? status = null,Object? statusLabel = null,Object? isFinal = null,Object? availableTransitions = null,Object? isEditable = null,Object? isStockable = null,Object? orderId = freezed,Object? orderItemId = freezed,Object? order = freezed,Object? customerId = freezed,Object? customer = freezed,Object? productId = freezed,Object? productVariantId = freezed,Object? product = freezed,Object? variant = freezed,Object? assignedToUserId = freezed,Object? assignee = freezed,Object? createdByUserId = freezed,Object? creator = freezed,Object? description = freezed,Object? supplies = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,code: null == code ? _self.code : code // ignore: cast_nullable_to_non_nullable
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,code,source,sourceLabel,name,unit,unitLabel,requiredQuantity,suppliedQuantity,remainingQuantity,totalPaid,status,statusLabel,isFinal,const DeepCollectionEquality().hash(_availableTransitions),isEditable,isStockable,orderId,orderItemId,order,customerId,customer,productId,productVariantId,product,variant,assignedToUserId,assignee,createdByUserId,creator,description,const DeepCollectionEquality().hash(_supplies),createdAt,updatedAt]);
...
/// Create a copy of Shortage
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? code = null,Object? source = null,Object? sourceLabel = null,Object? name = null,Object? unit = freezed,Object? unitLabel = freezed,Object? requiredQuantity = null,Object? suppliedQuantity = null,Object? remainingQuantity = null,Object? totalPaid = null,Object? status = null,Object? statusLabel = null,Object? isFinal = null,Object? availableTransitions = null,Object? isEditable = null,Object? isStockable = null,Object? orderId = freezed,Object? orderItemId = freezed,Object? order = freezed,Object? customerId = freezed,Object? customer = freezed,Object? productId = freezed,Object? productVariantId = freezed,Object? product = freezed,Object? variant = freezed,Object? assignedToUserId = freezed,Object? assignee = freezed,Object? createdByUserId = freezed,Object? creator = freezed,Object? description = freezed,Object? supplies = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
