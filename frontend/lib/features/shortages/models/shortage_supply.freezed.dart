...
/// never off [kind].
@JsonKey(name: 'is_reversible') bool get isReversible;@JsonKey(name: 'reverses_supply_id') int? get reversesSupplyId;@JsonKey(name: 'recorded_by_user_id') int? get recordedByUserId; ShortageSupplyPersonRef? get recorder;@JsonKey(name: 'created_at') DateTime? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,shortageId,kind,kindLabel,quantity,amount,method,methodLabel,reference,occurredOn,notes,warehouseId,warehouse,stockMovementId,movedStock,isReversal,isReversed,isReversible,reversesSupplyId,recordedByUserId,recorder,createdAt]);

@override
String toString() {
  return 'ShortageSupply(id: $id, shortageId: $shortageId, kind: $kind, kindLabel: $kindLabel, quantity: $quantity, amount: $amount, method: $method, methodLabel: $methodLabel, reference: $reference, occurredOn: $occurredOn, notes: $notes, warehouseId: $warehouseId, warehouse: $warehouse, stockMovementId: $stockMovementId, movedStock: $movedStock, isReversal: $isReversal, isReversed: $isReversed, isReversible: $isReversible, reversesSupplyId: $reversesSupplyId, recordedByUserId: $recordedByUserId, recorder: $recorder, createdAt: $createdAt)';
}
...
as bool,reversesSupplyId: freezed == reversesSupplyId ? _self.reversesSupplyId : reversesSupplyId // ignore: cast_nullable_to_non_nullable
