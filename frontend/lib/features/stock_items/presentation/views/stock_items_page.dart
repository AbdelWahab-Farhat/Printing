...
/// «المواد» — the shelves themselves, and the screen that curates them.
///
  ...
  Future<void> _confirmDelete(BuildContext context, StockItem item) async {
    ...
    if (item.isDrawnFrom) {
      context.showInfo(
        ...
        details: '${item.sharedByLabel}. غيّر ارتباط تلك المقاسات بمادة أخرى أولاً.',
      );
    ...
    final confirmed = await showDestructiveDialog(
      ...
      description:
          'تختفي المادة من القوائم، وتبقى حركاتها المسجّلة وسجل تعديلاتها كما هي. '
          'يُرفض الحذف إن كان أي مخزن ما زال يحتوي كمية منها — سوِّ الجرد أو انقل الكمية أولاً. '
          'إن كان المقصود التوقف عن عرضها فالإيقاف أفضل.',
    );
