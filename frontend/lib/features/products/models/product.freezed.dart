...
/// is the one thing on the card safe to read down a phone line.
 String get code; String get slug; String get name; String? get description; List<String> get features;/// The Arabic label for it, sent by the server so the app keeps no translation table.
...
@JsonKey(name: 'product_category') ProductCategory? get productCategory;@JsonKey(name: 'product_category_id') int? get productCategoryId;@JsonKey(name: 'pricing_unit') String get pricingUnit;@JsonKey(name: 'pricing_unit_label') String get pricingUnitLabel;/// **What the warehouse counts this in, which is not always what the customer is charged
...
@JsonKey(name: 'stock_unit') String get stockUnit;@JsonKey(name: 'stock_unit_label') String get stockUnitLabel;@JsonKey(name: 'pricing_mode') String get pricingMode;@JsonKey(name: 'pricing_mode_label') String get pricingModeLabel;/// Whether to render a price or "السعر حسب الطلب" — the server's answer, not a rule the app
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,code,slug,name,description,const DeepCollectionEquality().hash(features),productCategory,productCategoryId,pricingUnit,pricingUnitLabel,stockUnit,stockUnitLabel,pricingMode,pricingModeLabel,hasListedPrices,minOrderQuantity,isActive,sortOrder,const DeepCollectionEquality().hash(variants),const DeepCollectionEquality().hash(images),createdAt,updatedAt]);

@override
String toString() {
  return 'Product(id: $id, code: $code, slug: $slug, name: $name, description: $description, features: $features, productCategory: $productCategory, productCategoryId: $productCategoryId, pricingUnit: $pricingUnit, pricingUnitLabel: $pricingUnitLabel, stockUnit: $stockUnit, stockUnitLabel: $stockUnitLabel, pricingMode: $pricingMode, pricingModeLabel: $pricingModeLabel, hasListedPrices: $hasListedPrices, minOrderQuantity: $minOrderQuantity, isActive: $isActive, sortOrder: $sortOrder, variants: $variants, images: $images, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 int id, String code, String slug, String name, String? description, List<String> features,@JsonKey(name: 'product_category') ProductCategory? productCategory,@JsonKey(name: 'product_category_id') int? productCategoryId,@JsonKey(name: 'pricing_unit') String pricingUnit,@JsonKey(name: 'pricing_unit_label') String pricingUnitLabel,@JsonKey(name: 'stock_unit') String stockUnit,@JsonKey(name: 'stock_unit_label') String stockUnitLabel,@JsonKey(name: 'pricing_mode') String pricingMode,@JsonKey(name: 'pricing_mode_label') String pricingModeLabel,@JsonKey(name: 'has_listed_prices') bool hasListedPrices,@JsonKey(name: 'min_order_quantity') String minOrderQuantity,@JsonKey(name: 'is_active') bool isActive,@JsonKey(name: 'sort_order') int sortOrder, List<ProductVariant> variants, List<ProductImage> images,@JsonKey(name: 'created_at') DateTime? createdAt,@JsonKey(name: 'updated_at') DateTime? updatedAt
});
...
/// Create a copy of Product
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? code = null,Object? slug = null,Object? name = null,Object? description = freezed,Object? features = null,Object? productCategory = freezed,Object? productCategoryId = freezed,Object? pricingUnit = null,Object? pricingUnitLabel = null,Object? stockUnit = null,Object? stockUnitLabel = null,Object? pricingMode = null,Object? pricingModeLabel = null,Object? hasListedPrices = null,Object? minOrderQuantity = null,Object? isActive = null,Object? sortOrder = null,Object? variants = null,Object? images = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
as String,stockUnit: null == stockUnit ? _self.stockUnit : stockUnit // ignore: cast_nullable_to_non_nullable
as String,stockUnitLabel: null == stockUnitLabel ? _self.stockUnitLabel : stockUnitLabel // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String code,  String slug,  String name,  String? description,  List<String> features, @JsonKey(name: 'product_category')  ProductCategory? productCategory, @JsonKey(name: 'product_category_id')  int? productCategoryId, @JsonKey(name: 'pricing_unit')  String pricingUnit, @JsonKey(name: 'pricing_unit_label')  String pricingUnitLabel, @JsonKey(name: 'stock_unit')  String stockUnit, @JsonKey(name: 'stock_unit_label')  String stockUnitLabel, @JsonKey(name: 'pricing_mode')  String pricingMode, @JsonKey(name: 'pricing_mode_label')  String pricingModeLabel, @JsonKey(name: 'has_listed_prices')  bool hasListedPrices, @JsonKey(name: 'min_order_quantity')  String minOrderQuantity, @JsonKey(name: 'is_active')  bool isActive, @JsonKey(name: 'sort_order')  int sortOrder,  List<ProductVariant> variants,  List<ProductImage> images, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Product() when $default != null:
return $default(_that.id,_that.code,_that.slug,_that.name,_that.description,_that.features,_that.productCategory,_that.productCategoryId,_that.pricingUnit,_that.pricingUnitLabel,_that.stockUnit,_that.stockUnitLabel,_that.pricingMode,_that.pricingModeLabel,_that.hasListedPrices,_that.minOrderQuantity,_that.isActive,_that.sortOrder,_that.variants,_that.images,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String code,  String slug,  String name,  String? description,  List<String> features, @JsonKey(name: 'product_category')  ProductCategory? productCategory, @JsonKey(name: 'product_category_id')  int? productCategoryId, @JsonKey(name: 'pricing_unit')  String pricingUnit, @JsonKey(name: 'pricing_unit_label')  String pricingUnitLabel, @JsonKey(name: 'stock_unit')  String stockUnit, @JsonKey(name: 'stock_unit_label')  String stockUnitLabel, @JsonKey(name: 'pricing_mode')  String pricingMode, @JsonKey(name: 'pricing_mode_label')  String pricingModeLabel, @JsonKey(name: 'has_listed_prices')  bool hasListedPrices, @JsonKey(name: 'min_order_quantity')  String minOrderQuantity, @JsonKey(name: 'is_active')  bool isActive, @JsonKey(name: 'sort_order')  int sortOrder,  List<ProductVariant> variants,  List<ProductImage> images, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Product():
return $default(_that.id,_that.code,_that.slug,_that.name,_that.description,_that.features,_that.productCategory,_that.productCategoryId,_that.pricingUnit,_that.pricingUnitLabel,_that.stockUnit,_that.stockUnitLabel,_that.pricingMode,_that.pricingModeLabel,_that.hasListedPrices,_that.minOrderQuantity,_that.isActive,_that.sortOrder,_that.variants,_that.images,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String code,  String slug,  String name,  String? description,  List<String> features, @JsonKey(name: 'product_category')  ProductCategory? productCategory, @JsonKey(name: 'product_category_id')  int? productCategoryId, @JsonKey(name: 'pricing_unit')  String pricingUnit, @JsonKey(name: 'pricing_unit_label')  String pricingUnitLabel, @JsonKey(name: 'stock_unit')  String stockUnit, @JsonKey(name: 'stock_unit_label')  String stockUnitLabel, @JsonKey(name: 'pricing_mode')  String pricingMode, @JsonKey(name: 'pricing_mode_label')  String pricingModeLabel, @JsonKey(name: 'has_listed_prices')  bool hasListedPrices, @JsonKey(name: 'min_order_quantity')  String minOrderQuantity, @JsonKey(name: 'is_active')  bool isActive, @JsonKey(name: 'sort_order')  int sortOrder,  List<ProductVariant> variants,  List<ProductImage> images, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Product() when $default != null:
return $default(_that.id,_that.code,_that.slug,_that.name,_that.description,_that.features,_that.productCategory,_that.productCategoryId,_that.pricingUnit,_that.pricingUnitLabel,_that.stockUnit,_that.stockUnitLabel,_that.pricingMode,_that.pricingModeLabel,_that.hasListedPrices,_that.minOrderQuantity,_that.isActive,_that.sortOrder,_that.variants,_that.images,_that.createdAt,_that.updatedAt);case _:
  return null;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,code,slug,name,description,const DeepCollectionEquality().hash(_features),productCategory,productCategoryId,pricingUnit,pricingUnitLabel,stockUnit,stockUnitLabel,pricingMode,pricingModeLabel,hasListedPrices,minOrderQuantity,isActive,sortOrder,const DeepCollectionEquality().hash(_variants),const DeepCollectionEquality().hash(_images),createdAt,updatedAt]);
