    ...
    return Column(
      ...
      children: [
        ...
        Text(
          ...
          'كل صنف هنا رصيد واحد في المخازن، مهما بلغ عدد المنتجات التي تسحب منه. '
          'تغيير اسم المادة يُعيد تسمية هذه الأصناف كلها.',
    ...
    if (items.isEmpty) {
      return Padding(
        ...
        child: Text(
          ...
          'لا أصناف تحت هذه المادة بعد. يُنشأ الصنف تلقائياً حين يختار منتج هذه المادة '
          'عند مقاس ما.',
