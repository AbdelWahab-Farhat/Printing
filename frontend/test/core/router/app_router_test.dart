...
void main() {
  ...
  test('every link this app can build opens something', () {
    ...
    final links = <String, String>{
      ...
      'أمر شراء من مورد': Routes.newVendorPurchaseOrder(9),
      'أوامر الشراء': Routes.purchaseOrders,
      'نموذج أمر الشراء': Routes.purchaseOrderForm,
      'أمر شراء واحد': Routes.purchaseOrder(4),
