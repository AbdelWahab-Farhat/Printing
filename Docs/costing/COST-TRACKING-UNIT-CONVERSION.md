...
>
> Companion docs: [PURCHASE-ORDERS-DESIGN.md](../purchase-orders/PURCHASE-ORDERS-DESIGN.md) and
> [VENDORS-AND-PURCHASE-ORDERS.md](../vendors/VENDORS-AND-PURCHASE-ORDERS.md) for the purchase order
