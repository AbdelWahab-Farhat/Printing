...
| [PARTIAL-DELIVERY-DESIGN.md](orders/PARTIAL-DELIVERY-DESIGN.md) | التسليم الجزئي — الباقي يعود للمخزن إن كان سادة، ويُسجَّل خسارة إن كان مطبوعاً. **مقترح**؛ الفرع `feat/partial-delivery`، وأسئلة §٧ مفتوحة. |
