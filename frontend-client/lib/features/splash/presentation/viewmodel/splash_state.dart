...
/// server did not answer" is the whole point — one of them is the customer's problem to solve
/// with a password, and the other is not their problem at all.
@freezed
sealed class SplashState with _$SplashState {
  /// The wordmark, and a request in flight.
