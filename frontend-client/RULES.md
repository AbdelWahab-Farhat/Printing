# دعاية (Dayaa) — تطبيق العميل — Flutter Rules
...
> **هذا الملف يحمل قواعد الـ Flutter، ويغلب عند التعارض.** كل المسارات نسبية إلى `frontend-client/`.
>
> **وهو نسخة قواعد [../frontend/RULES.md](../frontend/RULES.md) حرفاً بحرف.** التطبيقان اثنان،
> والقواعد واحدة: من عمل في أحدهما يعمل في الآخر بلا إعادة تعلّم. تعديلٌ هنا دون هناك يفتح
> فرقاً بين مستودعين لا شيء يبقيهما متزامنين — فإن تغيّرت قاعدة، تتغيّر في الملفين معاً.
>
> ما **لم** يُنقل من هناك، وسببه، في [BACKLOG.md](BACKLOG.md).
