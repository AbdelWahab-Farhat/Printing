...
>
> Companion docs: [COST-TRACKING-UNIT-CONVERSION.md](COST-TRACKING-UNIT-CONVERSION.md) for the
> batch-costing machinery this extends, [INVENTORY-STOCK-SCREEN.md](INVENTORY-STOCK-SCREEN.md),
> and [PROFIT-AND-LOSS-COST-TRACKING.md](PROFIT-AND-LOSS-COST-TRACKING.md) for where these
> numbers end up.
