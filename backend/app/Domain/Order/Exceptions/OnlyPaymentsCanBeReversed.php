...
/**
 * A reversal says "this never happened". Only a payment can be wrong in that way.
 *
 ...
 */
final class OnlyPaymentsCanBeReversed extends DomainException
{
    public static function make(OrderPaymentType $type): self
    {
        return new self("لا يمكن إلغاء قيد من نوع «{$type->label()}» — الإلغاء للدفعات وحدها");
    }
}
