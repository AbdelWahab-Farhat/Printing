...
class InventoryService
{
    ...
    /**
     * Declares what this shelf is counted in, restamping every existing balance and batch for it —
     * see {@see SetStockItemUnit}. Replaces the old per-product `setStockUnit()`: a unit is a fact
     * about the pile, and two products sharing one pile must not be able to disagree about it.
     */
    public function setStockItemUnit(StockItem $item, PricingUnit $unit): StockItem
    {
        return ($this->setStockItemUnit)($item, $unit);
    }
